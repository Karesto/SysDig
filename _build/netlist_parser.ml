...
# 220 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
    ( xs )
...
# 201 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
    ( x :: xs )
...
# 231 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
    ( x :: xs )
# 507 "netlist_parser.ml"
    ...
    | MenhirState9 ->
        ...
        let _v : ((Netlist_ast.Env.key * Netlist_ast.ty) list) = 
# 144 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
    ( x )
...
and _menhir_reduce18 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : (Netlist_ast.equation list) = 
# 199 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
    ( [] )
...
# 802 "netlist_parser.ml"
    ...
    | IN ->
        ...
        let (_menhir_stack, _menhir_s, (x : (Netlist_ast.Env.key * Netlist_ast.ty))) = _menhir_stack in
        let _v : ((Netlist_ast.Env.key * Netlist_ast.ty) list) = 
# 229 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
    ( [ x ] )
    ...
    | MenhirState7 ->
        ...
        | VAR ->
            ...
            | IN ->
                ...
                let _v : ((Netlist_ast.Env.key * Netlist_ast.ty) list) = 
# 142 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
    ( [] )
...
# 233 "/home/ahmed/.opam/4.06.1/lib/menhir/standard.mly"
